...
// Game Modes
const GAME_MODE_RANKED = Symbol('Chế độ Xếp Hạng');
const GAME_MODE_CASUAL = Symbol('Chế độ Thường');

// Available Menus
const MENU_MAIN = Symbol('Menu Chính');
const MENU_PAUSE = Symbol('Tạm Dừng');
const MENU_SCORE = Symbol('Điểm');
...
function renderScoreHud() {
    ...
    cubeCountNode.innerText = `Số khối lập phương: ${state.game.cubeCount}`;
}
...
function renderMenus() {
    ...
    switch (state.menus.active) {
        ...
        case MENU_SCORE:
            ...
            if (isNewHighScore()) {
                highScoreLblNode.textContent = 'Thành tích mới!';
            } else {
